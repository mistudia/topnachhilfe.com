  ...
  return (
    ...
    >
      <p>
        ...
        Geschäftsleitung der miStudia Online Nachhilfe. Eine Nutzung der
        Internetseiten der Nachhilfe ist grundsätzlich ohne jede Angabe
      ...
      <p>
        ...
        für diese Verarbeitung keine gesetzliche Grundlage, holen wir generell
      ...
      <p>
        ...
        Übereinstimmung mit den für die miStudia Online Nachhilfe geltenden
      ...
      <p>
        Die miStudia Online Nachhilfe hat als für die Verarbeitung
      ...
      <p>
        Die Datenschutzerklärung der miStudia Online Nachhilfe beruht auf den
      ...
      <p>
        {brand.privacy.controller}
        <br />
        Tel.:{" "}
        <a href={`tel:${brand.phone.replace(/\s/g, "")}`}>{brand.phone}</a>
        <br />
        E-Mail:{" "}
        <a href={`mailto:${brand.privacy.contactEmail}`}>
          {brand.privacy.contactEmail}
        </a>
        <br />
      ...
      <p>
        ...
        sicherzustellen sowie die Nutzerfreundlichkeit zu verbessern.
      </p>
      <p>
        Einige Cookies sind technisch erforderlich und werden auf Grundlage von
        Art. 6 Abs. 1 lit. f DSGVO gespeichert. Andere Cookies (z. B. zur
        Einbindung externer Dienste) setzen wir nur mit Ihrer Einwilligung gemäß
        Art. 6 Abs. 1 lit. a DSGVO ein.
      </p>
      <p>
        Zur Verwaltung Ihrer Einwilligungen nutzen wir ein Cookie-Consent-Tool.
      ...
      <p>
        Die Internetseite der miStudia Online Nachhilfe erfasst mit jedem Aufruf
      ...
      <p>
        ...
        miStudia Online Nachhilfe keine Rückschlüsse auf die betroffene Person.
        ...
        erhobenen Daten und Informationen werden durch die miStudia Online
        Nachhilfe daher einerseits statistisch und ferner mit dem Ziel
      ...
      <h3>4a. Hosting</h3>
      <p>Unsere Website wird bei einem externen Dienstleister gehostet.</p>
      <p>
        Anbieter ist STRATO AG, Otto-Ostrowski-Straße 7, 10249 Berlin,
        Deutschland.
      </p>
      <p>
      ...
      <p>
        Wir haben mit dem Anbieter einen Vertrag zur Auftragsverarbeitung
        geschlossen.
      </p>
      <h3>4b. Hosting über GitHub Pages</h3>
      <p>
        Unsere Spielanwendung (Vokabelspiel) wird zusätzlich über GitHub Pages
        bereitgestellt.
      </p>
      <p>
        Anbieter ist GitHub Inc., 88 Colin P. Kelly Jr. Street, San Francisco,
        CA 94107, USA.
      </p>
      <p>
        Beim Aufruf dieser Seiten werden durch GitHub automatisch technische
        Daten erfasst (z. B. IP-Adresse, Browserinformationen,
        Zugriffszeitpunkte). Diese Daten werden in sogenannten Server-Logfiles
        verarbeitet, um die Stabilität und Sicherheit des Dienstes zu
        gewährleisten.
      </p>
      <p>
        Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO
        (berechtigtes Interesse an einer sicheren und stabilen Bereitstellung
        unseres Online-Angebots). Eine Übermittlung von Daten in die USA kann
        nicht ausgeschlossen werden. GitHub ist Teil von Microsoft und nutzt
        Standardvertragsklauseln gemäß Art. 46 DSGVO.
      </p>
      <h3>4c. Speicherung von Spieldaten im Browser (LocalStorage)</h3>
      <p>
        Unsere Spielanwendung (Vokabelspiel) speichert bestimmte Informationen
        lokal im Browser des Nutzers (sogenannter LocalStorage). Dabei kann es
        sich insbesondere um Spielstände, Fortschritte und Einstellungen (z. B.
        ausgewählte Vokabeln oder Spielmodi) handeln.
      </p>
      <p>
        Diese Daten werden ausschließlich lokal auf dem Endgerät des Nutzers
        gespeichert und nicht an unsere Server übertragen. Die Speicherung
        erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO (berechtigtes
        Interesse), um die Funktionalität und Nutzerfreundlichkeit unseres
        Spiels zu gewährleisten. Nutzer können die gespeicherten Daten jederzeit
        selbst über die Einstellungen ihres Browsers löschen.
      </p>
      <h3>4d. Webanalyse mit Umami</h3>
      <p>
        Zur statistischen Auswertung der Besucherzugriffe nutzen wir den
        datenschutzfreundlichen Webanalysedienst Umami Analytics. Anbieter ist
        Umami Software Inc.
      </p>
      <p>
        Umami verwendet keine Cookies und speichert keine personenbezogenen
        Daten. Die IP-Adressen werden anonymisiert verarbeitet. Es werden
        insbesondere aufgerufene Seiten, verwendeter Browser, Gerätetyp,
        Herkunftsland und Zugriffszeitpunkt erfasst.
      </p>
      <p>
        Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1 lit. f DSGVO
        (berechtigtes Interesse an der Analyse und Optimierung unseres
        Onlineangebotes). Weitere Informationen finden Sie unter{" "}
        <a href="https://umami.is/privacy">https://umami.is/privacy</a>.
      </p>

      <h2>5. Kontaktmöglichkeit über die Internetseite</h2>
      <p>
        Wenn Sie uns per E-Mail oder Kontaktformular Anfragen zukommen lassen,
        werden Ihre Angaben inklusive der von Ihnen angegebenen Kontaktdaten
        gespeichert. Die Verarbeitung erfolgt auf Grundlage von Art. 6 Abs. 1
        lit. b DSGVO (Bearbeitung Ihrer Anfrage) sowie Art. 6 Abs. 1 lit. f
        DSGVO. Diese Daten geben wir nicht ohne Ihre Einwilligung weiter.
      </p>
      <h3>5a. Terminbuchung über Calendly</h3>
      <p>
        Zur Online-Terminvereinbarung nutzen wir Calendly. Anbieter ist Calendly
        LLC, USA. Die Einbindung von Calendly auf unserer Website erfolgt nur
        mit Ihrer Einwilligung gemäß Art. 6 Abs. 1 lit. a DSGVO.
      </p>
      <p>
        Wenn Sie einen Termin buchen, werden personenbezogene Daten (z. B. Name,
        E-Mail-Adresse) verarbeitet. Diese Verarbeitung erfolgt zur Durchführung
        vorvertraglicher Maßnahmen bzw. zur Vertragserfüllung gemäß Art. 6 Abs.
        1 lit. b DSGVO. Eine Datenübertragung in die USA kann nicht
        ausgeschlossen werden und erfolgt auf Grundlage geeigneter Garantien
        gemäß Art. 46 DSGVO.
      </p>
      <h3>5b. Videokonferenzen (Senfcall / Zoom)</h3>
      <p>
        Für die Durchführung von Online-Nachhilfe nutzen wir
        Videokonferenzdienste, insbesondere Senfcall sowie ggf. Zoom oder
        andere. Bei der Nutzung dieser Dienste werden personenbezogene Daten
        verarbeitet, insbesondere Name, E-Mail-Adresse, IP-Adresse sowie Audio-
        und Videodaten.
      </p>
      <p>
        Die Verarbeitung erfolgt zur Durchführung der Online-Nachhilfe (Art. 6
        Abs. 1 lit. b DSGVO) sowie auf Grundlage unseres berechtigten Interesses
        an einer effizienten Kommunikation (Art. 6 Abs. 1 lit. f DSGVO). Je nach
        Anbieter kann eine Übermittlung personenbezogener Daten in Drittländer
        außerhalb der EU erfolgen. In diesen Fällen erfolgt die
        Datenübermittlung auf Grundlage geeigneter Garantien gemäß Art. 46 DSGVO
        oder – mit Ihrer ausdrücklichen Einwilligung.
      </p>
      <p>
        Die Nutzung von Zoom erfolgt auf Grundlage eines Vertrags zur
        Auftragsverarbeitung. Eine Datenübertragung in die USA kann nicht
        ausgeschlossen werden. Weitere Informationen entnehmen Sie bitte den
        Datenschutzerklärungen der jeweiligen Anbieter. Eine Übermittlung in
        Drittländer (z. B. USA) kann nicht ausgeschlossen werden.
      </p>
      <h3>5c. Nutzung von Excalidraw</h3>
      <p>
        Zur Unterstützung der Online-Nachhilfe nutzen wir das Whiteboard-Tool
        Excalidraw. Dabei können technische Daten (z. B. IP-Adresse) sowie
        Inhalte, die im Whiteboard erstellt werden, verarbeitet werden.
      </p>
      <p>
        Die Nutzung erfolgt zur Durchführung der Nachhilfe auf Grundlage von
        Art. 6 Abs. 1 lit. b DSGVO sowie auf Grundlage unseres berechtigten
        Interesses an einer effektiven Wissensvermittlung gemäß Art. 6 Abs. 1
        lit. f DSGVO. Excalidraw wird in der Regel lokal im Browser ausgeführt.
        Eine Speicherung der Inhalte erfolgt nur im Rahmen der Nutzung. Eine
        Übermittlung an externe Server kann je nach technischer Einbindung nicht
        vollständig ausgeschlossen werden.
      </p>
      <h3>5d. Zahlungsabwicklung über Stripe</h3>
      <p>
        Für die Abwicklung von Zahlungen nutzen wir den Zahlungsdienstleister
        Stripe. Anbieter ist Stripe Payments Europe Ltd., 1 Grand Canal Street
        Lower, Grand Canal Dock, Dublin, Irland.
      </p>
      <p>
        Wenn Sie eine Zahlung tätigen, werden Ihre Zahlungsdaten (z. B. Name,
        E-Mail-Adresse, Zahlungsbetrag sowie ggf. weitere zur Zahlungsabwicklung
        erforderliche Daten) an Stripe übermittelt. Die Verarbeitung erfolgt auf
        Grundlage von Art. 6 Abs. 1 lit. b DSGVO (Vertragserfüllung).
      </p>
      <p>
        Stripe kann Daten auch an seine Muttergesellschaft in die USA
        übermitteln. Die Datenübertragung erfolgt auf Grundlage von
        Standardvertragsklauseln gemäß Art. 46 DSGVO. Weitere Informationen
      ...
      <ul>
        ...
        <li>
          das Bestehen eines Rechts auf Berichtigung oder Löschung, auf
      ...
      <p>
        ...
        Mitarbeiter der miStudia Online Nachhilfe wenden.
      </p>
      ...
      <p>
        Die miStudia Online Nachhilfe verarbeitet die personenbezogenen Daten im
        ...
        Verteidigung von Rechtsansprüchen. Verarbeitet die miStudia Online
        Nachhilfe personenbezogene Daten, um Direktwerbung zu betreiben, kann
        die betroffene Person jederzeit Widerspruch gegen die Verarbeitung zum
        Zwecke derartiger Werbung einlegen. Dies gilt auch für Profiling, soweit
      ...
      <p>
        ...
        oder zu statistischen Zwecken gemäß Art. 89 Abs. 1 DS-GVO Widerspruch
        einzulegen, es sei denn, die Verarbeitung ist zur Erfüllung einer im
        öffentlichen Interesse liegenden Aufgabe erforderlich. Zur Ausübung des
        Rechts kann sich die betroffene Person direkt an jeden Mitarbeiter
        wenden und ihr Widerspruchsrecht im Zusammenhang mit Diensten der
        Informationsgesellschaft ungeachtet der Richtlinie 2002/58/EG mittels
        automatisierter Verfahren ausüben.
      </p>
      <h3>
      ...
      <p>
        ...
        betroffenen Person, trifft die miStudia Online Nachhilfe angemessene
        ...
        Entscheidung gehört. Möchte eine betroffene Person Rechte mit Bezug auf
      ...
      <p>
        ...
        jederzeit zu widerrufen. Möchte eine betroffene Person ihr Recht auf
      ...
      <p>
        ...
        wie dies beispielsweise bei Verarbeitungsvorgängen der Fall ist, die für
        eine Lieferung von Waren oder die Erbringung einer sonstigen Leistung
        oder Gegenleistung notwendig sind, so beruht die Verarbeitung auf Art. 6
        I lit. b DS-GVO. Gleiches gilt für solche Verarbeitungsvorgänge, die zur
      ...
      <p>
        In seltenen Fällen könnte die Verarbeitung personenbezogener Daten
        ...
        die Auffassung, dass ein berechtigtes Interesse anzunehmen sein könnte,
        wenn die betroffene Person ein Kunde des Verantwortlichen ist
      ...
      <p>
        ...
        einer Bereitstellung muss sich die betroffene Person an einen
        Mitarbeiter wenden. Unser Mitarbeiter klärt den Betroffenen
        einzelfallbezogen darüber auf, ob die Bereitstellung gesetzlich oder
        vertraglich vorgeschrieben oder für den Vertragsabschluss erforderlich
        ist, ob eine Verpflichtung besteht und welche Folgen die
